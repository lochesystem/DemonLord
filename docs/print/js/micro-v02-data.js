...
const MICRO_RACES_BASE = [
  { id: 'R01', name: 'Harpia', pv: 3, atk: 4, int: 2, cost: 4, trait: 'Voador', art: '🦅', effect: '—' },
  { id: 'R02', name: 'Gárgula', pv: 5, atk: 3, int: 1, cost: 4, trait: 'Voador', art: '🗿', effect: 'Enquanto estiver: +1 PV sob Terreno urbano.' },
  { id: 'R03', name: 'Morcego Infernal', pv: 2, atk: 2, int: 3, cost: 2, trait: 'Voador', art: '🦇', effect: 'Ao entrar: olhe a próxima Raça; devolva ao topo ou ao fundo.' },
  { id: 'R04', name: 'Mantícora', pv: 4, atk: 5, int: 2, cost: 5, trait: 'Voador', art: '🦂', effect: 'Ao entrar: um rival descarta 1 Raça de PV 2 ou menos.' },
  { id: 'R05', name: 'Golem', pv: 6, atk: 5, int: 1, cost: 5, trait: 'Bruto', art: '🪨', effect: 'Enquanto estiver: +1 PV se sua INT total for 5 ou menos.' },
  { id: 'R06', name: 'Goblin', pv: 2, atk: 2, int: 3, cost: 2, trait: 'Furtivo', art: '👺', effect: '—' },
  { id: 'R07', name: 'Gremlin Fiscal', pv: 2, atk: 1, int: 4, cost: 2, trait: 'Furtivo', art: '🧾', effect: 'Enquanto estiver: mantenha +1◆ sobre cada outra Raça sua.' },
  { id: 'R08', name: 'Ogro', pv: 5, atk: 6, int: 1, cost: 5, trait: 'Bruto', art: '👹', effect: '—' },
  { id: 'R09', name: 'Súcubo', pv: 3, atk: 3, int: 5, cost: 4, trait: 'Arcano', art: '😈', effect: 'Ao entrar: roube 1 Item aleatório da mão de um rival.' },
  { id: 'R10', name: 'Tritão', pv: 4, atk: 3, int: 2, cost: 3, trait: 'Nadador', art: '🔱', effect: '—' },
  { id: 'R11', name: 'Kobold', pv: 2, atk: 1, int: 4, cost: 2, trait: 'Furtivo', art: '🐲', effect: 'Enquanto estiver: +1 INT se controlar outro Furtivo.' },
  { id: 'R12', name: 'Minotauro', pv: 5, atk: 5, int: 2, cost: 5, trait: 'Bruto', art: '🐂', effect: '—' },
  { id: 'R13', name: 'Espectro', pv: 2, atk: 2, int: 4, cost: 3, trait: 'Arcano', art: '👻', effect: 'Ignora penalidades de Terreno físico.' },
  { id: 'R14', name: 'Slime', pv: 4, atk: 2, int: 1, cost: 2, trait: 'Nadador', art: '🟢', effect: '—' },
  { id: 'R15', name: 'Lagáxido', pv: 3, atk: 2, int: 3, cost: 3, trait: 'Nadador', art: '🦎', effect: 'Ao entrar: Goblins ficam −2 ATK até o fim da rodada.' },
  { id: 'R16', name: 'Diabrete', pv: 2, atk: 3, int: 3, cost: 3, trait: 'Arcano', art: '🔥', effect: '—' },
  { id: 'R17', name: 'Centauro', pv: 4, atk: 4, int: 2, cost: 4, trait: 'Batedor', art: '🐎', effect: 'Enquanto estiver: outras Raças recebem +1 ATK na rodada em que entram.' },
];
